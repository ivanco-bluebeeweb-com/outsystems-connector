"""Panel UI for OutSystems Connector following UI_INTERFACE_STANDARD.md."""
...
def _help_modal() -> ui.UINode:
    return ui.Modal(
        ...
        children=[
            ui.Text(
                "1. Sign in to your OutSystems dashboard and navigate to API/Integration settings.\n"
...
async def main_panel(ctx) -> ui.UINode:
    ...
    return ui.Stack(
        ...
        gap=2,
        children=[
            ui.Heading("OutSystems Connector", level=3),
            ui.Text("Connect and manage your OutSystems workspace.", variant="caption"),
            ui.Divider(),
            form,
            ui.Divider(),
            _help_modal(),
