"""Pydantic schemas for OutSystems Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary OutSystems.")
    api_token: str = Field(description="Platform API Key / Access Token")
    base_url: str = Field(default="https://api.outsystems.com/lifetime/v1", description="OutSystems API base URL.")
...
class GetAppRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    apprecord_id: str = Field(description="OutSystems AppRecord ID.")
