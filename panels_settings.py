"""Settings panel for OutSystems Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__outsystems_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=outsystems_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_outsystems"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("OutSystems Settings & Accounts", level=2),
